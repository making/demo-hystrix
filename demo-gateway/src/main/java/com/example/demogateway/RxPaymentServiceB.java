...
@Component
public class RxPaymentServiceB {
	private final WebClient webClient;

	public RxPaymentServiceB(WebClient.Builder builder, GatewayProperties props) {
		this.webClient = builder.baseUrl(props.getServiceB())
	...
	@HystrixCommand(commandKey = "rxPaymentB", //
			commandProperties = {
